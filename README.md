...
**_Version 2 of @erboladaiorg/voluptatum-quasi has been written from scratch and is not compatible with version 1 (see migration)._**

There are two different flavors available to use. Please visit the **documentation** of the links below and pick the one you
prefer.

* The [@erboladaiorg/voluptatum-quasi-category-style](./category-style/README.MD) flavor.
* The [@erboladaiorg/voluptatum-quasi-log4ts-style](./log4ts-style/README.MD) flavor.

**Node Channel (NEW)**

Supports logging to files and file rollover. Please see [@erboladaiorg/voluptatum-quasi-node-channel](./node-channel/README.MD) for details.
...
Please visit
[https://github.com/erboladaiorg/voluptatum-quasi/tree/release-1.x](https://github.com/erboladaiorg/voluptatum-quasi/tree/release-1.x)
for more details. Consider upgrading to the latest version.

**Version 2 of @erboladaiorg/voluptatum-quasi is _not_ compatible with version 1**
